...
const AlphabetLevel: React.FC<AlphabetLevelProps> = ({ onBack }) => {
  const { t } = useLanguage();
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <Card className="level-card text-center space-y-8 animate-bounce-in">
          <div className="space-y-6">
            ...
            <div 
              className="text-9xl font-bold bg-gradient-primary bg-clip-text text-transparent 
                cursor-pointer transition-all duration-300 hover:scale-110 animate-float"
            ...
            <div className="flex gap-4 justify-center">
              <Button
                ...
                className="game-button bg-gradient-accent text-white"
                size="lg"
              >
              ...
              <Button
                ...
                className="game-button bg-gradient-secondary text-white"
                size="lg"
              >
                <Volume2 className="w-5 h-5 mr-2" />
                {currentAlphabet.word}
            ...
            {/* Success Message */}
            {currentLetter === alphabet.length - 1 && stars >= 3 && (
